...
public class feedback_workoutJR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_workout_jr);
    ...
    public void doneFun(View view) {
        ...
        databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(date).child("FeedbackWorkout").setValue(""+q).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    startActivity(new Intent(feedback_workoutJR.this,maindashboard.class));
                }
            }
        });
