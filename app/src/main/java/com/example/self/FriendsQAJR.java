...
public class FriendsQAJR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friends_qajr);
    ...
    public void doneFun(View view) {
        ...
        databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(date).child("FriendsQA").setValue(""+q).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    startActivity(new Intent(FriendsQAJR.this,maindashboard.class));
                }
            }
        });
