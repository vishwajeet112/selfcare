...
public class FeedbackWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_workout);
        ...
        databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(date).child("FeedbackWorkout").setValue(""+q).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    startActivity(new Intent(FeedbackWorkout.this,maindashboard.class));
                }
            }
        });
