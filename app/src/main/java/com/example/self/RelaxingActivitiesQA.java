...
public class RelaxingActivitiesQA extends AppCompatActivity {
  ...
  DatabaseReference databaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relaxing_activities_qa);
    ...
    public void doneFun(View view) {
        ...
        databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(date).child("RelaxationActivitiesQA").setValue(""+q).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    startActivity(new Intent(RelaxingActivitiesQA.this,maindashboard.class));
                }
            }
        });
