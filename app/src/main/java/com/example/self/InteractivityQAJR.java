...
public class InteractivityQAJR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interqajr);
    ...
    public void doneFun(View view) {
        ...
        databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(date).child("InteractivityQA").setValue(""+q).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    startActivity(new Intent(InteractivityQAJR.this,maindashboard.class));
                }
            }
        });
