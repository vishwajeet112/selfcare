...
public class FamilyQA extends AppCompatActivity {
    int cal=0; private RadioGroup radioGroup1,radioGroup2,radioGroup3,radioGroup4,radioGroup5;
    private TextView t1,t2,t3,t4,t5;int q1,q2,q3,q4,q5;
    public static final String VALUE ="FamilyQA.name";
   // Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_family_qa);
        ...
        databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(date).child("FamilyQA").setValue(""+q).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    startActivity(new Intent(FamilyQA.this,maindashboard.class));
                }
            }
        });
