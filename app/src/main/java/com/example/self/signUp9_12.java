...
public class signUp9_12 extends AppCompatActivity {
    private DatePickerDialog datePickerDialog;
    private Button dob;
    Spinner gender,class_grade; private EditText guardianMail,yourMail,yourPhn,password,confirmPassword,name;
    ArrayAdapter<CharSequence> gender_adapter,class_grade_adapter; private FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up912);
       ...
       dob=findViewById(R.id.datePickerButton);
        ...
        class_grade_adapter=ArrayAdapter.createFromResource(this,R.array.class_9_12_array,R.layout.class_spinner_layout);
...
//    }
    ...
    private void createUser() {
        ...
        String sguardianMail,syourMail,syourPhn,spassword,sconfirmPassword,sdob,sgender,sclass,role="Student(9-12)";
                        ...
                        FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(signUp9_12.this, "User signed up successfully", Toast.LENGTH_SHORT).show();
                                            startActivity(new Intent(signUp9_12.this,MainActivity.class));
                                        }else {
                                            Toast.makeText(signUp9_12.this, "Error\t"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
